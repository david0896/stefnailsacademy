...
export default function NuevoCursoPage() {
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      const res = await fetch('/api/backoffice/cursos', {
        method: 'POST',
    ...
    <BOLayout>
      <div className="max-w-2xl">
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
          ...
          <span>/</span>
          <span className="text-gray-700">Nuevo curso</span>
        </div>

        <h1 className="text-xl font-semibold text-gray-900 mb-6">Crear nuevo curso</h1>
