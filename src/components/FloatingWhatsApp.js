...
export default function FloatingWhatsApp({
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className={`group fixed bottom-5 right-5 z-[100] flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-[#25D366] hover:bg-[#1ebe57] text-white shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-110 ${styles.pulse}`}
    >
