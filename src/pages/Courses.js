...
const Courses = ({cursos}) => {
    ...
    return (
        <div className="w-10/12 mx-auto pb-10">
            ...
            <h2 className="text-2xl xl:text-3xl font-bold text-[#383838] mt-10 mb-5">Conoce nuestro proximo curso ideal para ti</h2>
            {ProximoCurso ? (
                <> 
                    ...
                    <h3 className="text-xl lg:text-2xl font-bold text-[#383838] mt-10 mb-5">Conoce los siguientes cursos que tendremos para ti</h3>
